...
(function () {
  var Routes = function () {
    var self = this,
        routes = {"rails_info_properties":{"defaults":{},"path":"/rails/info/properties"},"rails_info_routes":{"defaults":{},"path":"/rails/info/routes"},"rails_info":{"defaults":{},"path":"/rails/info"},"rails_mailers":{"defaults":{},"path":"/rails/mailers"},"root":{"defaults":{},"path":"/"},"posts":{"defaults":{},"path":"/posts"},"new_post":{"defaults":{},"path":"/posts/new"},"edit_post":{"defaults":{},"path":"/posts/:id/edit"},"post":{"defaults":{},"path":"/posts/:id"},"rails_service_blob":{"defaults":{},"path":"/rails/active_storage/blobs/:signed_id/*filename"},"rails_blob_representation":{"defaults":{},"path":"/rails/active_storage/representations/:signed_blob_id/:variation_key/*filename"},"rails_disk_service":{"defaults":{},"path":"/rails/active_storage/disk/:encoded_key/*filename"},"update_rails_disk_service":{"defaults":{},"path":"/rails/active_storage/disk/:encoded_token"},"rails_direct_uploads":{"defaults":{},"path":"/rails/active_storage/direct_uploads"}};
